...
CREATE OR REPLACE TRIGGER insert_relation_trigger
AFTER INSERT ON relation
FOR EACH ROW
BEGIN
-- Insert into book table
INSERT INTO book (book_no, book_name, author, book_edition, course_offering)
VALUES (:new.book_no, NULL, NULL, NULL, NULL);
-- Insert into course table
INSERT INTO course (course_no, course_name, year_semister, credit, dept_id)
VALUES (:new.course_no, NULL, NULL, NULL, NULL);
END;
/
